...
public class Sounds {
    ...
    public static void soundGo(){ //suono generato quando viene cliccato il pulsante avanti
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/go.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
    ...
    public static void soundBack(){ //suono generato quando viene cliccato il pulsante indietro
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/back.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundInfo(){ //suono generato quando compare la scena info
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/info.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundOpen(){ //suono generato quando si apre il programma
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/open.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundClose(){ //suono generato quando si chiude il programma
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/close1.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
        ...
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/close2.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundWelcome(){ //suono generato quando si accede per la prima volta il menu
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/welcome.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundLogout(){ //suono generato quando si accede per la prima volta il menu
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/logout.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundLoading(){ //suono generato quando compare la scena del caricamento
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/loading.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundPositiveAndQuestionNotify(){ //suono generato quando compare la scena della risposta positiva e della domanda
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/positiveAndQuestionNotify.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
    ...
    public static void soundNegativeNotify(){ //suono generato quando compare la scena della risposta negativa
        try {
            ...
            InputStream audioDyPath = Sounds.class.getResourceAsStream("/org/sounds/negativeNotify.wav"); //inserisco dinamicamente il file audio
            BufferedInputStream readAudio = new BufferedInputStream(audioDyPath); //leggo dinamicamente il file audio
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(readAudio); //e passo come input audio
            Clip clip = AudioSystem.getClip();
            clip.open(audioStream);
